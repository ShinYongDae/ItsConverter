...
void CSimpleOpengl::DrawStrPcs(tagStrPcs& StrPcs)
{
	...
	CItsConverterDlg* pParent = (CItsConverterDlg*)m_pParent;
	...
	for (k = 0; k < nTotPnl; k++) // Draw Panel from Left to Right. 
	{
		...
		for (i = 0; i < nTotPcs; i++)
		{
			...
			int nCase = SetItsRgnOrg(nR, nC, v1, v2, StrPcs);
...
int CSimpleOpengl::SetItsRgnOrg(int nR, int nC, stVertex v1, stVertex v2, tagStrPcs& StrPcs)
{
